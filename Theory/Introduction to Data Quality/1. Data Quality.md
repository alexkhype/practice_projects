...
* Completeness can be assessed at the dataset or individual data element level. **It measures whether all expected records are present and whether required data fields are populated.**
* Missing data skews analysis and can lead to poor decisions. For example, a missing customer name in a record violates completeness rules.

## Validity as a dimension

- Validity checks whether data values meet predefined business criteria. **Validity is measured as the proportion of valid values, such as dates being in the past or values matching expected categories**. 
- Invalid entries, such as future birth dates or incorrect account types, indicate data quality issues.

## Uniqueness as a dimension

- **Uniqueness ensures there are no duplicate records in a dataset**. Business context determines what constitutes a duplicate, often checked by unique identifiers like CustomerID. 
- Duplicate full records or entries reduce data quality and violate uniqueness constraints.
